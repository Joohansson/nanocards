...
class App extends Component {
  ...
  constructor(props) {
    ...
    '<ol>'+
      ...
      '<li>Download this script for converting the cards. <a href="https://raw.githubusercontent.com/Joohansson/nanocards/master/scripts/cut.bat">Windows</a> or <a href="https://raw.githubusercontent.com/Joohansson/nanocards/master/scripts/cut.sh">Linux/Mac</a><br />If not printing from makeplayingcards.com you may want to skip the safe zone by using the <a href="https://github.com/Joohansson/nanocards/tree/master/scripts/">other scripts</a>.</li>'+
